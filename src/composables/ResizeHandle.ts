...
export class ResizeHandle extends EventEmitter {
  handleElt: HTMLDivElement;
  targetElt: HTMLElement;
  updatedSizes: {width:number, height:number};
  ...
  constructor(targetElt: HTMLElement, direction: string, options?: { collapsable?: boolean; }) {
    ...
    //set new size immediately
    this.updatedSizes = {width: this.targetElt.offsetWidth, height: this.targetElt.offsetHeight};
